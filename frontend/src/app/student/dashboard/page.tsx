  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="bg-white rounded-2xl p-12 border border-gray-100 shadow-sm text-center">
        ...
        <h3 className="text-lg font-semibold text-gray-900 mb-2">Welcome to Metacognition Test</h3>
        <p className="text-gray-600">
          Your metacognition assessments and results will appear here. Stay tuned for new tests!
        </p>
      </div>
    </div>
  );
