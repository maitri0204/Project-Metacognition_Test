  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="bg-white rounded-2xl p-12 border border-gray-100 shadow-sm text-center">
        ...
        <h3 className="text-lg font-semibold text-gray-900 mb-2">Welcome to the Admin Panel</h3>
        <p className="text-gray-600">
          Start managing metacognition tests and monitor student progress from here.
        </p>
      </div>
    </div>
  );
