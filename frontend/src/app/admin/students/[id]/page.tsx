        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mt-4">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-gray-900 mt-0.5">{student.email}</p>
            </div>
            <div>
              <p className="text-xs font-semibold text-gray-400 uppercase tracking-wide">Mobile</p>
              <p className="text-sm font-medium text-gray-900 mt-0.5">{student.mobile || "—"}</p>
            </div>
            <div>
              <p className="text-xs font-semibold text-gray-400 uppercase tracking-wide">City</p>
              <p className="text-sm font-medium text-gray-900 mt-0.5">{student.city || "—"}</p>
            </div>
            <div>
              <p className="text-xs font-semibold text-gray-400 uppercase tracking-wide">State</p>
              <p className="text-sm font-medium text-gray-900 mt-0.5">{student.state || "—"}</p>
            </div>
          </div>
